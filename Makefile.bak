...
PLATFORM=debug-darwin64-x86_64-cc
OPTIONS=--prefix=/usr/local/openssl-dev no-ec_nistp_64_gcc_128 no-gmp no-jpake no-krb5 no-md2 no-rc4 no-rc5 no-rfc3779 no-shared no-store no-zlib no-zlib-dynamic static-engine
CONFIGURE_ARGS=debug-darwin64-x86_64-cc no-rc4 --prefix=/usr/local/openssl-dev
...
INSTALL_PREFIX=
INSTALLTOP=/usr/local/openssl-dev

# Do not edit this manually. Use Configure --openssldir=DIR do change this!
OPENSSLDIR=/usr/local/openssl-dev/ssl
...
CC= cc
CFLAG= -DOPENSSL_THREADS -D_REENTRANT -DDSO_DLFCN -DHAVE_DLFCN_H -arch x86_64 -g3 -DL_ENDIAN -Wall -DOPENSSL_IA32_SSE2 -DOPENSSL_BN_ASM_MONT -DOPENSSL_BN_ASM_MONT5 -DOPENSSL_BN_ASM_GF2m -DSHA1_ASM -DSHA256_ASM -DSHA512_ASM -DMD5_ASM -DAES_ASM -DVPAES_ASM -DBSAES_ASM -DWHIRLPOOL_ASM -DGHASH_ASM
DEPFLAG= -DOPENSSL_NO_EC_NISTP_64_GCC_128 -DOPENSSL_NO_GMP -DOPENSSL_NO_JPAKE -DOPENSSL_NO_MD2 -DOPENSSL_NO_RC4 -DOPENSSL_NO_RC5 -DOPENSSL_NO_RFC3779 -DOPENSSL_NO_STORE
...
ENGINES_ASM_OBJ= e_padlock-x86_64.o
...
SDIRS=  \
	...
	des aes rc2 idea bf cast camellia seed modes \
